<div class="card-body">
  <div class="row">
    ...
    <div class="form-group col-md-6 col-12 mb-3">
      ...
      <textarea class="form-control summernote" name="description" rows="3" placeholder="Product Description" required>{{@$product->description}}</textarea>
      @error('description')
      <div class="text-danger">{{ $message }}</div>
      @enderror
    </div>
    ...
    <div class="form-group col-md-6 col-12 mb-3">
      ...
      <textarea class="form-control summernote" name="key_features" rows="3" placeholder="Product Key Features" required>{{@$product->key_features}}</textarea>
      @error('key_features')
      <div class="text-danger">{{ $message }}</div>
      @enderror
    </div>
    ...
    <div class="form-group col-md-6 col-12 mb-3">
      ...
      <textarea class="form-control summernote" name="disclaimer" rows="3" placeholder="Product Disclaimer" required>{{@$product->disclaimer}}</textarea>
      @error('disclaimer')
      <div class="text-danger">{{ $message }}</div>
      @enderror
    </div>
