<div class="btn-group">
  <a href="{{ route('admin.testimonial.edit', $id) }}" class='btn btn-sm btn-info tooltip-box'>
...
<form id="delete_form-{{$id}}" action="{{ route('admin.testimonial.destroy', $id) }}" method="post">
    @csrf @method('delete')
</form>
