<div class="btn-group">
  <a href="{{ route('admin.requirement.edit', $id) }}" class='btn btn-sm btn-info tooltip-box'>
...
<form id="delete_form-{{$id}}" action="{{ route('admin.requirement.destroy', $id) }}" method="post">
    @csrf @method('delete')
</form>