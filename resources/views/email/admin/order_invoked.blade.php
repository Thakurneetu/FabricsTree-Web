                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;" class="wrapper">
                    ...
                    <tr>
                        <td class="content">
                            ...
                            <p>Customer has invoked the order. Please find the details below and follow up accordingly.</p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" class="details-table">
                                ...
                                <tr>
                                    <td class="label">Revoke Reason:</td>
                                    <td>{{$data['order']->revoke_reason ?? 'N/A'}}</td>
                                </tr>
                                <tr>
