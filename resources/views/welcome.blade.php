      ...
      <div class="modal-content">
        <div class="modal-header">
          <div class="text-center w-100">
            <h1 class="modal-title fs-4" id="exampleModalLabel loginheding">Log in</h1>
          </div>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Email / Mobile Number*</label>
          ...
          <div class="mb-3">
            ...
            <p class="Forgot" data-bs-toggle="modal" data-bs-target="#exampleModalforget">Forgot Your Password?</p>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-primary w-100 loginbtn">Sign in</button>
          <div class="text-center w-100">
            <p class="newregistation" type="submit" data-bs-toggle="modal"
          data-bs-target="#exampleModalregistation">New Here? Registration </p>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Email or phone number</label>
            <input type="email" class="form-control" id="exampleFormControlInput1"
              placeholder="Enter your email address">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary w-100 loginbtn">Submit</button>
  ...
  <div class="modal fade login" id="exampleModalregistation" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <div class="text-center w-100">
            <h1 class="modal-title fs-4" id="exampleModalLabel loginheding">Registration</h1>
          </div>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
              <div class="mb-3">
                ...
                <input type="password" class="form-control" placeholder="Enter your email id">
              </div>
            </div>
            ...
            <div class="col-md-6 col-sm-12">
              <div class="mb-3">
                ...
                <input type="password" class="form-control" placeholder="Enter your mobile number">
              </div>
            </div>
            ...
            <div class="col-md-6 col-sm-12">
              <div class="mb-3">
                ...
                <textarea class="form-control" placeholder="Enter your address" id="exampleFormControlTextarea1" rows="3"></textarea>
              </div>
            </div>
            ...
            <div class="text-center w-100">
              <p class="newregistation" type="submit" data-bs-toggle="modal"
            data-bs-target="#exampleModal">Already have an account? Sign in </p>
